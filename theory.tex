...
Using $n_f=5$ at $\mu_R = m_Z$ and the $\overline{\text{MS}}$ renormalization scheme~\cite{msbar}, we find $\Lambda_\mathrm{QCD} = 218$ MeV.
...
It results in an asymptotically ($\mu_R\rightarrow \infty$) free theory.
...
\end{align}
The diagonization of this mass term gives 3 massive weak bosons (consuming the 3 massless Nambu-Goldstone bosons) and one massless photon:
\begin{align}
...
\end{gather}
The breaking of the $\SU(2)\times \U(1)$ symmetry leaves behind a local $\U(1)$ symmetry (with gauge boson $A_\mu$), which corresponds to electromagnetism (EM).
