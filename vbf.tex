...
The upper limits are shown in Figure~\ref{fig:vbf:mhscan}, and the observed (expected) limits exclude $m_H<550$ GeV ($600$ GeV) assuming a branching ratio of $100\%$. 
...
\begin{figure}[]
    \begin{center}
        ...
        \caption{Upper limits on $\sigma\times \mathcal{B}$ as a function of $m_H$, assuming VBF as the only production mode.
                The predicted cross section (assuming $\mathcal{B}=1$) is shown in red.}
...
\begin{figure}[]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/vbf/fits/comb.pdf}
        \caption{Upper limits on $\sigma\times \mathcal{B}$ as a function of $m_H$, assuming VBF as the only production mode.
                The predicted cross section (assuming $\mathcal{B}=1$) is shown in red.}
        \label{fig:vbf:mhscan}
    \end{center}
