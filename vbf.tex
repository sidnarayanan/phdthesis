...
Assuming a background-only hypothesis, the expected distribution of upper limits has a median of $0.33$, with the one standard deviation band covering the interval $[0.18,0.35]$.
