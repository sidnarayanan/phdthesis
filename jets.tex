...
As indicated in Figure~\ref{fig:jets:caak}, the jet mass is a powerful observable, but top (QCD) jets do not necessarily have a mass of $m_t$ ($m_q,m_g\sim 0$). 
...
\end{equation}
where $p_\mathrm{T,i}$ refers to the $i$-th branch of the node; $\Delta R_{12}$ is the $\Delta R$-distance between the two branches; and $R$ and $\beta$ are tunable parameters. 
...
We will see that observables may also be defined in terms of the groomed or ungroomed jet. 
Figure~\ref{fig:jets:msd} compares the ungroomed and groomed mass distributions in top and QCD jets, as a function of jet momentum. 
It is immediately clear that grooming provides (a) a sharper mass peak in top jets at $m_t$ and (b) a smoothly falling mass distribution in QCD jets that goes to 0.
Furthermore, SD ensures the stability of the mass distribution as a function of jet \pt, especially in QCD jets.
...
\begin{figure}[]
    \begin{center}
        ...
        \begin{subfigure}[t]{0.35\textwidth}
            ...
            \caption{SD, Top}
        \end{subfigure}
        \caption{Distribution of ungroomed and groomed jet mass in CA15 jets originating from light $q/g$ partons or hadronic top decays.
